...
function ProductRing() {
  ...
  const specialpro = firstFiveProducts.filter(
    (itemSpecial) => itemSpecial.category?.name === "Nhẫn"
  );
    ...
    <div>
      ...
      <Container>
        <Banner
          ...
          pic1={
            "https://drive.google.com/thumbnail?id=1CC5L7IMkjFX4t6hC-SEnh0v3lnzlTIoD&sz=w1000"
          }
          pic2={
            "https://drive.google.com/thumbnail?id=1TSu4mkJHy9ucTWQhRRqdK5FswjO6snRZ&sz=w1000"
          }
          pic3={
            "https://drive.google.com/thumbnail?id=17TafMMY2QsClp9XFB9z6Giuq3Rtg8qwr&sz=w1000"
          }
          pic4={
