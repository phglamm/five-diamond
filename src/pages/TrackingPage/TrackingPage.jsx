                    ...
                    <Row className="Rowall">
                        <Col md={8} className="Col8">
                            ...
                            <Form.Group as={Row} controlId="formFullName" className="align-items-center">
                                ...
                                <Col md={10}>
                                    <Form.Control type="text" placeholder="Nhập họ tên" value={name} readOnly />
                                </Col>
                            </Form.Group>
                            <Form.Group as={Row} controlId="formPhoneNumber" className="align-items-center">
                                ...
                                <Col md={10}>
                                    <Form.Control type="text" placeholder="Nhập số điện thoại" value={phone} readOnly />
                                </Col>
                            </Form.Group>
...
{/* <option value="">Chọn Tỉnh/TP</option> */}
                            ...
                            <Form.Group controlId="formAddress">
                                ...
                                <Form.Control type="text" placeholder="Nhập địa chỉ" value={address} readOnly />
                            </Form.Group>
...
/>
                            ...
                            <Form.Group controlId="formPaymentMethod">
                                ...
                                <div>
                                    <p>
                                        Quý khách vu6i lòng kiểm tra sự nguyên vẹn của gói hàng và tem niêm phong, trước khi thanh toán tiền mặt và nhận hàng
                            ...
                            <Form.Group controlId="formNote">
                                <Form.Control as="textarea" rows={3} placeholder="Để lại lời nhắn" value={note} readOnly />
                            </Form.Group>
                        </Col>
                        <Col md={4}>
                            ...
                            {items.map((item) => (
                                <div key={item.msp} className="order-item">
                                    <img src={`https://example.com/${item.msp}.jpg`} alt="Product Image" className="checkout-image" />
                            ...
                            <h5>Tạm tính: <span style={{ color: 'red' }}>{subtotal.toLocaleString()}đ</span></h5>
