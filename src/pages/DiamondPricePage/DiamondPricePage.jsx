      ...
      <tr key={color}>
        ...
        {columnHeaders.map((clarity) => {
          const priceData = diamondPrices.find(
            (price) =>
              price.size === size &&
              price.clarity === clarity &&
              price.color === color
          );
          return (
            <td key={clarity}>
              {priceData
                ? `${parseFloat(priceData.price)?.toLocaleString()} VNĐ`
                : "N/A"}
            </td>
          );
        })}
        ...
        <Container>
          ...
          <div>
            ...
            <Table bordered className="price-table">
              ...
              <tbody>{renderTableCells("3.6")}</tbody>
            </Table>
          </div>
          <div>
            ...
            <Table bordered className="price-table">
              ...
              <tbody>{renderTableCells("4.1")}</tbody>
            </Table>
          </div>
          <div>
            ...
            <Table bordered className="price-table">
              ...
              <tbody>{renderTableCells("4.5")}</tbody>
            </Table>
          </div>
          <div>
            ...
            <Table bordered className="price-table">
              ...
              <tbody>{renderTableCells("5.4")}</tbody>
            </Table>
          </div>
        </Container>
      </div>
